...
public class FiveDaysWeatherDataPuller implements WeatherDataPuller {
    ...
    public void updateWeatherData() {
        ...
        AtmosphericPressureModel rpm = client.exchange(forecastUrl, AtmosphericPressureModel.class);
    ...
    private Map<LocalDate, Double> calculateDailyAverageWeatherPressure(AtmosphericPressureModel rpm) {

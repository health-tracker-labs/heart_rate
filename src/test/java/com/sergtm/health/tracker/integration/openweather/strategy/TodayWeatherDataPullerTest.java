...
class TodayWeatherDataPullerTest {
    ...
    @Test
    void shouldPersistTodayWeatherWhenWeatherEntryDoesNotExistInDB() {
    ...
    @Test
    void shouldUpdateTodayWeatherWhenWeatherEntryExistInDB() {
    ...
    @Test
    void shouldReturnTodayWeatherTypeForTodayWeatherDataPuller() {
